...
<p>首先选择要安装的版本</p>
<div class="z-wrap"><form class="z-form z-global" onchange="form_update(event)" onsubmit="return false"><div><label for="571e51bb" title>MongoDB 版本号</label><select id="571e51bb" name="version" title><option value="6.0">6.0</option><option value="5.0">5.0</option><option value="4.4">4.4</option><option value="4.2">4.2</option></select></div></form></div>
...
<div class="z-wrap"><form class="z-form" onchange="form_update(event)" onsubmit="return false"><div><label for="dd6016dd" title>发行版</label><select id="dd6016dd" name="release" title><option value="bullseye">Debian 11 (bullseye)</option><option value="buster">Debian 10 (buster)</option><option value="stretch">Debian 9 (stretch) (EOL)</option><option value="jessie">Debian 8 (jessie) (EOL)</option><option value="jammy">Ubuntu 22.04 LTS (jammy)</option><option value="focal">Ubuntu 20.04 LTS (focal)</option><option value="bionic">Ubuntu 18.04 LTS (bionic)</option><option value="xenial">Ubuntu 16.04 LTS (xenial) (EOL)</option></select></div></form><pre class="z-code"></pre></div><tmpl z-input="release" z-path="/etc/apt/sources.list.d/mongodb.list">
